...
def decade_trend(area):
    ...
    for start_year in range(1981, 2010, 10):
...
# precip_glb_decadal_trend.to_csv('precip_glb_decadal_trend_old.csv',index=False)
# precip_ask_decadal_trend.to_csv('precip_ask_decadal_trend_old.csv',index=False)
# precip_es_decadal_trend.to_csv('precip_es_decadal_trend_old.csv',index=False)
# precip_ys_decadal_trend.to_csv('precip_ys_decadal_trend_old.csv',index=False)
# precip_ecs_decadal_trend.to_csv('precip_ecs_decadal_trend_old.csv',index=False)
