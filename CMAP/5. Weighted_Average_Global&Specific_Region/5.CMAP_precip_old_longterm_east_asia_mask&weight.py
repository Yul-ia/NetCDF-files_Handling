...
os.chdir('')
### old clim file
ds_precip = xr.open_dataset('CMAP_longterm/CMAP_precip_mon_clim_8110.nc') # [mm/day] > [mm/month]
...
os.getcwd()
new_df.to_csv('precip_old_lonterm_east_asia_mask&weighted.csv',index=False)
