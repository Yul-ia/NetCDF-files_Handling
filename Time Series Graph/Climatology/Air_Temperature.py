...
def subplot_plot(era5_new, ncep_r2_new,
                      ...
                      y_range=(80, 125, 5),
                      title = 'Global Sea Climatology Air Temperature',
    ...
    tick_labels = ['1월', '2월', '3월', '4월', '5월', '6월', '7월', '8월', '9월', '10월', '11월', '12월']  # 레이블
...
#%%
os.chdir('')
ncep_r2_new = pd.read_csv('data/NCEP_R2/6.anom_std_csv/air_anom_std_new.csv')
ncep_r2_old = pd.read_csv('data/NCEP_R2/6.anom_std_csv/air_anom_std_old.csv')
ncep_r2_present = pd.read_csv('data/NCEP_R2/6.anom_std_csv/ncep_air_(clim,anom,std)_present.csv')

era5_new = pd.read_csv('data/ERA5/airtemp_month_new.csv')
era5_old = pd.read_csv('data/ERA5/airtemp_month_old.csv')
era5_present = pd.read_csv('data/ERA5/airtemp_month_present.csv')
...
era5_new['year'] = era5_new['year'].str.replace('/ufeff', '').astype(int)
era5_new['month'] = era5_new['month'].astype(int)

era5_old['year'] = era5_old['year'].str.replace('/ufeff', '').astype(int)
era5_old['month'] = era5_old['month'].astype(int)

era5_present['year'] = era5_present['year'].str.replace('/ufeff', '').astype(int)
...
group_plot(era5_present, ncep_r2_present,
           ...
           y_range = (15,18.5,0.5),
           title = 'Global Sea Climatology Air Temperature',
           dir = 'climatology_present/air/glb_present', 
           file_name = "air_glb_clim(1)", 
...
group_plot(era5_new, ncep_r2_new,
           ...
           y_range = (15,18.5,0.5),
           title = 'Global Sea Climatology Air Temperature',
           dir = 'climatology_present/air/glb_new', 
           file_name = "air_glb_clim(1)", 
...
group_plot(era5_old, ncep_r2_old,
           ...
           y_range = (15,18.5,0.5),
           title = 'Global Sea Climatology Air Temperature',
           dir = 'climatology_present/air/glb_old', 
           file_name = "air_glb_clim(1)", 
...
group_plot(era5_present, ncep_r2_present,
           ...
           y_range = (6,30,3),
           title = 'East Asia Sea Climatology Air Temperature',
           dir = 'climatology_present/air/ask_present', 
           file_name = "air_ask_clim(1)", 
           title_suffix = '1994-2023',
           y_label = 'Air Temperature[℃]')
...
group_plot(era5_new, ncep_r2_new,
           ...
           y_range = (6,30,3),
           title = 'East Asia Sea Climatology Air Temperature',
           dir = 'climatology_present/air/ask_new', 
           file_name = "air_ask_clim(1)", 
           title_suffix = '1991-2020',
           y_label = 'Air Temperature[℃]')
...
group_plot(era5_old, ncep_r2_old,
           ...
           y_range = (6,30,3),
           title = 'East Asia Sea Climatology Air Temperature',
           dir = 'climatology_present/air/ask_old', 
           file_name = "air_ask_clim(1)", 
           title_suffix = '1981-2010',
           y_label = 'Air Temperature[℃]')
...
group_plot(era5_present, ncep_r2_present,
           ...
           y_range = (-5,35,5),
           title = 'Yellow Sea Climatology Air Temperature',
           dir = 'climatology_present/air/ys_present', 
           file_name = "air_ys_clim(1)", 
           title_suffix = '1994-2023',
           y_label = 'Air Temperature[℃]')
...
group_plot(era5_new, ncep_r2_new,
           ...
           y_range = (-5,35,5),
           title = 'Yellow Sea Climatology Air Temperature',
           dir = 'climatology_present/air/ys_new', 
           file_name = "air_ys_clim(1)", 
           title_suffix = '1991-2020',
           y_label = 'Air Temperature[℃]')
...
group_plot(era5_old, ncep_r2_old,
           ...
           y_range = (-5,35,5),
           title = 'Yellow Sea Climatology Air Temperature',
           dir = 'climatology_present/air/ys_old', 
           file_name = "air_ys_clim(1)", 
           title_suffix = '1981-2010',
           y_label = 'Air Temperature[℃]')
...
group_plot(era5_present, ncep_r2_present,
           ...
           y_range = (9,33,3),
           title = 'East China Sea Climatology Air Temperature',
           dir = 'climatology_present/air/ecs_present', 
           file_name = "air_ecs_clim(1)", 
           title_suffix = '1994-2023',
           y_label = 'Air Temperature[℃]')
...
group_plot(era5_new, ncep_r2_new,
           ...
           y_range = (9,33,3),
           title = 'East China Sea Climatology Air Temperature',
           dir = 'climatology_present/air/ecs_new', 
           file_name = "air_ecs_clim(1)", 
           title_suffix = '1991-2020',
           y_label = 'Air Temperature[℃]')
...
group_plot(era5_old, ncep_r2_old,
           ...
           y_range = (9,33,3),
           title = 'East China Sea Climatology Air Temperature',
           dir = 'climatology_present/air/ecs_old', 
           file_name = "air_ecs_clim(1)", 
           title_suffix = '1981-2010',
           y_label = 'Air Temperature[℃]')
...
group_plot(era5_present, ncep_r2_present,
           ...
           y_range = (-5,30,5),
           title = 'East Sea Climatology Air Temperature',
           dir = 'climatology_present/air/es_present', 
           file_name = "air_es_clim(1)", 
           title_suffix = '1994-2023',
           y_label = 'Air Temperature[℃]')
...
group_plot(era5_new, ncep_r2_new,
           ...
           y_range = (-5,30,5),
           title = 'East Sea Climatology Air Temperature',
           dir = 'climatology_present/air/es_new', 
           file_name = "air_es_clim(1)", 
           title_suffix = '1991-2020',
           y_label = 'Air Temperature[℃]')
...
group_plot(era5_old, ncep_r2_old,
           ...
           y_range = (-5,30,5),
           title = 'East Sea Climatology Air Temperature',
           dir = 'climatology_present/air/es_old', 
           file_name = "air_es_clim(1)", 
           title_suffix = '1981-2010',
           y_label = 'Air Temperature[℃]')
