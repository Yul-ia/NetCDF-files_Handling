...
def subplot_plot(era5_new, ncep_r2_new,
                      ...
                      y_range=(80, 125, 5),
                      title = 'Global Sea Climatology Sea Level Pressure',
...
group_plot(era5_present, ncep_r2_present,
           ...
           y_range = (1008,1013.5,0.5),
           title = 'Global Sea Climatology Sea Level Pressure',
           dir = 'd:\plot_yuri\climatology_present\pres\glb_present', 
           file_name = "pres_glb_clim(1)", 
...
group_plot(era5_new, ncep_r2_new,
           ...
           y_range = (1008,1013.5,0.5),
           title = 'Global Sea Climatology Sea Level Pressure',
           dir = 'd:\plot_yuri\climatology_present\pres\glb_new', 
           file_name = "pres_glb_clim(1)", 
...
group_plot(era5_old, ncep_r2_old,
           ...
           y_range = (1008,1013.5,0.5),
           title = 'Global Sea Climatology Sea Level Pressure',
           dir = 'd:\plot_yuri\climatology_present\pres\glb_old', 
           file_name = "pres_glb_clim(1)", 
...
group_plot(era5_present, ncep_r2_present,
           ...
           y_range = (1002, 1021, 2),
           title = 'East Asia Sea Climatology Sea Level Pressure',
           dir = 'climatology_present/pres/ask_present', 
           file_name = "pres_ask_clim(1)", 
           title_suffix = '1994-2023',
           y_label = 'Sea Level Pressure[hPa]')
...
group_plot(era5_new, ncep_r2_new,
           ...
           y_range = (1002, 1021, 2),
           title = 'East Asia Sea Climatology Sea Level Pressure',
           dir = 'climatology_present/pres/ask_new', 
           file_name = "pres_ask_clim(1)", 
           title_suffix = '1991-2020',
           y_label = 'Sea Level Pressure[hPa]')
...
group_plot(era5_old, ncep_r2_old,
           ...
           y_range = (1002, 1021, 2),
           title = 'East Asia Sea Climatology Sea Level Pressure',
           dir = 'climatology_present/pres/ask_old', 
           file_name = "pres_ask_clim(1)", 
           title_suffix = '1981-2010',
           y_label = 'Sea Level Pressure[hPa]')
...
group_plot(era5_present, ncep_r2_present,
           ...
           y_range = (995,1031,5),
           title = 'Yellow Sea Climatology Sea Level Pressure',
           dir = 'climatology_present/pres/ys_present', 
           file_name = "pres_ys_clim(1)", 
           title_suffix = '1994-2023',
           y_label = 'Sea Level Pressure[hPa]')
...
group_plot(era5_new, ncep_r2_new,
           ...
           y_range = (995,1031,5),
           title = 'Yellow Sea Climatology Sea Level Pressure',
           dir = 'climatology_present/pres/ys_new', 
           file_name = "pres_ys_clim(1)", 
           title_suffix = '1991-2020',
           y_label = 'Sea Level Pressure[hPa]')
...
group_plot(era5_old, ncep_r2_old,
           ...
           y_range = (995,1031,5),
           title = 'Yellow Sea Climatology Sea Level Pressure',
           dir = 'climatology_present/pres/ys_old', 
           file_name = "pres_ys_clim(1)", 
           title_suffix = '1981-2010',
           y_label = 'Sea Level Pressure[hPa]')
...
group_plot(era5_present, ncep_r2_present,
           ...
           y_range = (1000,1031,5),
           title = 'East China Sea Climatology Sea Level Pressure',
           dir = 'climatology_present/pres/ecs_present', 
           file_name = "pres_ecs_clim(1)", 
           title_suffix = '1994-2023',
           y_label = 'Sea Level Pressure[hPa]')
...
group_plot(era5_new, ncep_r2_new,
           ...
           y_range = (1000,1031,5),
           title = 'East China Sea Climatology Sea Level Pressure',
           dir = 'climatology_present/pres/ecs_new', 
           file_name = "pres_ecs_clim(1)", 
           title_suffix = '1991-2020',
           y_label = 'Sea Level Pressure[hPa]')
...
group_plot(era5_old, ncep_r2_old,
           ...
           y_range = (1000,1031,5),
           title = 'East China Sea Climatology Sea Level Pressure',
           dir = 'climatology_present/pres/ecs_old', 
           file_name = "pres_ecs_clim(1)", 
           title_suffix = '1981-2010',
           y_label = 'Sea Level Pressure[hPa]')
...
group_plot(era5_present, ncep_r2_present,
           ...
           y_range = (990,1026,5),
           title = 'East Sea Climatology Sea Level Pressure',
           dir = 'climatology_present/pres/es_present', 
           file_name = "pres_es_clim(1)", 
           title_suffix = '1994-2023',
           y_label = 'Sea Level Pressure[hPa]')
...
group_plot(era5_new, ncep_r2_new,
           ...
           y_range = (990,1026,5),
           title = 'East Sea Climatology Sea Level Pressure',
           dir = 'climatology_present/pres/es_new', 
           file_name = "pres_es_clim(1)", 
           title_suffix = '1991-2020',
           y_label = 'Sea Level Pressure[hPa]')
...
group_plot(era5_old, ncep_r2_old,
           ...
           y_range = (990,1026,5),
           title = 'East Sea Climatology Sea Level Pressure',
           dir = 'climatology_present/pres/es_old', 
           file_name = "pres_es_clim(1)", 
           title_suffix = '1981-2010',
           y_label = 'Sea Level Pressure[hPa]')
