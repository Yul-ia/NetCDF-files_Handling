...
def group_plot(era5_df, ncep_df,
                      ...
                      end_year = '2023',  
                      y_range=(70, 150, 10),
                      title = 'East Asia Monthly Mean Wind',
...
group_plot(era5_present, ncep_r2_present,
                  ...
                  end_year='2023',
                  y_range=(4, 7, 0.5),
                  title = 'Global Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/glb_present',
                  file_name = "wind_glb_mean(1)",
...
group_plot(era5_new, ncep_r2_new,
                  ...
                  y_range=(4, 7, 0.5),
                  title = 'Global Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/glb_new',
                  file_name = "wind_glb_mean(1)",
...
group_plot(era5_old, ncep_r2_old,
                  ...
                  y_range=(4, 7, 0.5),
                  title = 'Global Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/glb_old',
                  file_name = "wind_glb_mean(1)",
...
group_plot(era5_present, ncep_r2_present,
                  col_name='ask_mean',                  
                  y_range=(0,11,1),
                  title = 'East Asia Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/ask_present',
                  file_name = "wind_ask_mean(1)",
                  title_suffix='1994-2023',     
                  y_label='wind[m/s]')
...
group_plot(era5_new, ncep_r2_new,
                  ...
                  y_range=(0,11,1),
                  title = 'East Asia Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/ask_new',
                  file_name = "wind_ask_mean(1)",
                  title_suffix='1991-2020',     
                  y_label='wind[m/s]')
...
group_plot(era5_old, ncep_r2_old,
                  ...
                  y_range=(0,11,1),
                  title = 'East Asia Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/ask_old',
                  file_name = "wind_ask_mean(1)",
                  title_suffix='1981-2010',     
                  y_label='wind[m/s]')
...
group_plot(era5_present, ncep_r2_present,
                  col_name='ys_mean',
                  y_range=(0,9,1),
                  title = 'Yellow Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/ys_present',
                  file_name = "wind_ys_mean(1)",
                  title_suffix='1994-2023',     
                  y_label='wind[m/s]')
...
group_plot(era5_new, ncep_r2_new,
                  ...
                  end_year='2020',
                  title = 'Yellow Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/ys_new',
                  file_name = "wind_ys_mean(1)",
                  title_suffix='1991-2020',     
                  y_label='wind[m/s]')
...
group_plot(era5_old, ncep_r2_old,
                  ...
                  end_year='2010',
                  title = 'Yellow Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/ys_old',
                  file_name = "wind_ys_mean(1)",
                  title_suffix='1981-2010',     
                  y_label='wind[m/s]')
...
group_plot(era5_present, ncep_r2_present,
                  col_name='ecs_mean',
                  y_range=(0, 13, 2),
                  title = 'East China Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/ecs_present',
                  file_name = "wind_ecs_mean(1)",
                  title_suffix='1994-2023',     
                  y_label='wind[m/s]')
...
group_plot(era5_new, ncep_r2_new,
                  ...
                  end_year='2020',
                  title = 'East China Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/ecs_new',
                  file_name = "wind_ecs_mean(1)",
                  title_suffix='1991-2020',     
                  y_label='wind[m/s]')
...
group_plot(era5_old, ncep_r2_old,
                  ...
                  end_year='2010',
                  title = 'East China Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/ecs_old',
                  file_name = "wind_ecs_mean(1)",
                  title_suffix='1981-2010',     
                  y_label='wind[m/s]')
...
group_plot(era5_present, ncep_r2_present,
                  col_name='es_mean',
                  y_range=(0,13,2),
                  title = 'East Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/es_present',
                  file_name = "wind_es_mean(1)",
                  title_suffix='1994-2023',     
                  y_label='wind[m/s]')
...
group_plot(era5_new, ncep_r2_new,
                  ...
                  end_year='2020',
                  title = 'East Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/es_new',
                  file_name = "wind_es_mean(1)",
                  title_suffix='1991-2020',     
                  y_label='wind[m/s]')
...
group_plot(era5_old, ncep_r2_old,
                  ...
                  end_year='2010',
                  title = 'East Sea Monthly Mean Wind',
                  dir ='monthly_mean_present/wind/es_old',
                  file_name = "wind_es_mean(1)",
                  title_suffix='1981-2010',     
                  y_label='wind[m/s]')
