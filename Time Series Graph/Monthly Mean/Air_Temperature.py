...
def group_plot(era5_df, ncep_df,
                      ...
                      end_year = '2023',  
                      y_range=(70, 150, 10),
                      title = 'East Asia Monthly Mean air',
...
group_plot(era5_present, ncep_r2_present,
                  ...
                  end_year='2023',
                  y_range=(15, 18.5, 0.5),
                  title = 'Global Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/glb_present',
                  file_name = "air_glb_mean(1)",
...
group_plot(era5_new, ncep_r2_new,
                  ...
                  y_range=(15, 18.5, 0.5),
                  title = 'Global Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/glb_new',
                  file_name = "air_glb_mean(1)",
...
group_plot(era5_old, ncep_r2_old,
                  ...
                  y_range=(15, 18.5, 0.5),
                  title = 'Global Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/glb_old',
                  file_name = "air_glb_mean(1)",
...
group_plot(era5_present, ncep_r2_present,
                  col_name='ask_mean',                  
                  y_range=(6, 30, 3),
                  title = 'East Asia Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/ask_present',
                  file_name = "air_ask_mean(1)",
                  title_suffix='1994-2023',     
                  y_label='Air Temperature[°C]')
...
group_plot(era5_new, ncep_r2_new,
                  ...
                  y_range=(6, 30, 3),
                  title = 'East Asia Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/ask_new',
                  file_name = "air_ask_mean(1)",
                  title_suffix='1991-2020',     
                  y_label='Air Temperature[°C]')
...
group_plot(era5_old, ncep_r2_old,
                  ...
                  y_range=(6, 30, 3),
                  title = 'East Asia Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/ask_old',
                  file_name = "air_ask_mean(1)",
                  title_suffix='1981-2010',     
                  y_label='Air Temperature[°C]')
...
group_plot(era5_present, ncep_r2_present,
                  col_name='ys_mean',
                  y_range=(-5,31,5),
                  title = 'Yellow Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/ys_present',
                  file_name = "air_ys_mean(1)",
                  title_suffix='1994-2023',     
                  y_label='Air Temperature[°C]')
...
group_plot(era5_new, ncep_r2_new,
                  ...
                  end_year='2020',
                  title = 'Yellow Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/ys_new',
                  file_name = "air_ys_mean(1)",
                  title_suffix='1991-2020',     
                  y_label='Air Temperature[°C]')
...
group_plot(era5_old, ncep_r2_old,
                  ...
                  end_year='2010',
                  title = 'Yellow Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/ys_old',
                  file_name = "air_ys_mean(1)",
                  title_suffix='1981-2010',     
                  y_label='Air Temperature[°C]')
...
group_plot(era5_present, ncep_r2_present,
                  col_name='ecs_mean',
                  y_range=(9,31,3),
                  title = 'East China Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/ecs_present',
                  file_name = "air_ecs_mean(1)",
                  title_suffix='1994-2023',     
                  y_label='Air Temperature[°C]')
...
group_plot(era5_new, ncep_r2_new,
                  ...
                  end_year='2020',
                  title = 'East China Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/ecs_new',
                  file_name = "air_ecs_mean(1)",
                  title_suffix='1991-2020',     
                  y_label='Air Temperature[°C]')
...
group_plot(era5_old, ncep_r2_old,
                  ...
                  end_year='2010',
                  title = 'East China Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/ecs_old',
                  file_name = "air_ecs_mean(1)",
                  title_suffix='1981-2010',     
                  y_label='Air Temperature[°C]')
...
group_plot(era5_present, ncep_r2_present,
                  col_name='es_mean',
                  y_range=(-5,26,5),
                  title = 'East Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/es_present',
                  file_name = "air_es_mean(1)",
                  title_suffix='1994-2023',     
                  y_label='Air Temperature[°C]')
...
group_plot(era5_new, ncep_r2_new,
                  ...
                  end_year='2020',
                  title = 'East Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/es_new',
                  file_name = "air_es_mean(1)",
                  title_suffix='1991-2020',     
                  y_label='Air Temperature[°C]')
...
group_plot(era5_old, ncep_r2_old,
                  ...
                  end_year='2010',
                  title = 'East Sea Monthly Mean Air Temperature',
                  dir ='monthly_mean_present/air/es_old',
                  file_name = "air_es_mean(1)",
                  title_suffix='1981-2010',     
                  y_label='Air Temperature[°C]')
